...
alter table
  "public"."tv_series" enable row level security;
...
alter table
  "public"."tv_series"
add
  constraint "tv_series_pkey" PRIMARY KEY using index "tv_series_pkey";

alter table
  "public"."tv_series"
add
  constraint "tv_series_media_fkey" FOREIGN KEY (media_type, imdb_id) REFERENCES media(media_type, media_specific_id) not valid;

alter table
  "public"."tv_series" validate constraint "tv_series_media_fkey";

grant delete on table "public"."tv_series" to "anon";

grant
insert
  on table "public"."tv_series" to "anon";
...
grant
insert
  on table "public"."tv_series" to "authenticated";
...
grant
insert
  on table "public"."tv_series" to "service_role";
...
create policy "Allow authenticated users to read" on "public"."tv_series" as permissive for
select
  to authenticated using (true);

create policy "Allow service accounts to update" on "public"."tv_series" as permissive for all to service_role using (true);